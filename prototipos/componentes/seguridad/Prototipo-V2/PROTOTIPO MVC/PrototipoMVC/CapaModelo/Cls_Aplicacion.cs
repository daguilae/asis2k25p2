...
namespace Capa_Modelo_Seguridad
{
    public class Cls_Aplicacion
    {
        ...
        public Cls_Aplicacion(int iPkIdAplicacion, int? iFkIdReporte, string sNombreAplicacion, string sDescripcionAplicacion, bool bEstadoAplicacion)
        {
            this.iPkIdAplicacion = iPkIdAplicacion;
