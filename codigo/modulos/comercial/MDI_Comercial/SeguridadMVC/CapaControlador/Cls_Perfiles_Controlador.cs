...
namespace Capa_Controlador_Comercial
{
    // DTO para la vista
    ...
    {
        private Capa_Modelo_Comercial.Cls_PerfilesDAO daoPerfil = new Capa_Modelo_Comercial.Cls_PerfilesDAO();
        ...
        public bool bInsertarPerfil(string sPuesto, string sDescripcion, bool bEstado, int iTipo, out string mensaje)
        {
            ...
            var nuevoPerfil = new Capa_Modelo_Comercial.Cls_Perfiles
            {
        ...
        public bool bActualizarPerfil(int iIdPerfil, string sPuesto, string sDescripcion, bool bEstado, int iTipo, out string mensaje)
        {
            ...
            var perfilActualizado = new Capa_Modelo_Comercial.Cls_Perfiles
            {
