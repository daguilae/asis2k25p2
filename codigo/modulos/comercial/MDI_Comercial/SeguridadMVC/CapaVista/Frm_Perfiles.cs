    ...
    public partial class Frm_Perfiles : Form
    {
        ...
        private void Btn_guardar_Click(object sender, EventArgs e)
        {
            ...
            if (bExito)
            {
                ...
                ctrlBitacora.RegistrarAccion(Capa_Controlador_Comercial.Cls_Usuario_Conectado.iIdUsuario, 1, $"Guardó el perfil: {Txt_puesto.Text}", true);
                fun_ConfigurarComboBoxPerfiles();
                fun_LimpiarCampos();
                fun_Configuracioninicial();
            }
        ...
        private void Btn_modificar_Click(object sender, EventArgs e)
        {
            ...
            if (bExito)
            {
                ...
                ctrlBitacora.RegistrarAccion(Capa_Controlador_Comercial.Cls_Usuario_Conectado.iIdUsuario, 1, $"Modificó el perfil: {Txt_puesto.Text}", true);
                fun_ConfigurarComboBoxPerfiles();
                fun_LimpiarCampos();
                fun_Configuracioninicial();
            }
        ...
        private void Btn_Eliminar_Click(object sender, EventArgs e)
        {
            ...
            if (bExito)
            {
                ...
                ctrlBitacora.RegistrarAccion(Capa_Controlador_Comercial.Cls_Usuario_Conectado.iIdUsuario, 1, $"Eliminó el perfil: {Txt_puesto.Text}", true);
            }
            else
            {
