...
namespace Capa_Vista_Comercial
{
    ...
    public partial class Frm_asignacion_perfil_usuario : Form
    {
        ...
        {
            int idUsuario = Capa_Controlador_Comercial.Cls_Usuario_Conectado.iIdUsuario;
        ...
        private void Btn_eliminar_asignacion_Click_1(object sender, EventArgs e)
        {
            if (Dgv_asignaciones.CurrentRow != null)
            {
                ...
                if (usuarioRow != null && perfilRow != null)
                {
                    ...
                    ctrlBitacora.RegistrarAccion(Capa_Controlador_Comercial.Cls_Usuario_Conectado.iIdUsuario, 1, $"Se eliminó la asignación del perfil '{snombrePerfil}' para el usuario '{snombreUsuario}'", true);
                }
            }
        }
